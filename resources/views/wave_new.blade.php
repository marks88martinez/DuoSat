...
{{--<head>--}}
    ...
    <link rel="stylesheet" href="{{URL::to('vista/wave/style.css')}}">
            ...
            <div class="container">
                <div class="row text-center">
                    <div class="declaration">
                        ...
                        {{--<h1>NEXT</h1>--}}
                        <h4 class="fuente_titulo1">WAVE HD</h4>
                        <p class="fuent_new1">Wave  HD, Alta Definição para todos
                        </p>
                    ...
                    <div class="header_img">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <img src="{{URL::to('vista/wave/wave.png')}}" alt="">
        ...
        <div class="describe_area">
            <div class="container">
                <div class="row page_title text-center">
                    ...
                    <h6 class="fuent_new2">Um design compacto que cobre uma tendência de designs para uma sala de estar pequena, criada para uma população com cada vez menos espaço, mas elegante e de bom gosto. </h6>
                    <div class="row">
        ...
        <div class="screens_area">
            <div class="container">
                <div class="row page_title text-center">
                    ...
                    <h6 class="fuent_new1">Agora, o sistema de Streaming é muito mais rápido e com um desempenho melhorado graças ao seu Processador Dual-Core de 1GHz, que nos fornece uma experiência inimaginável.</h6>
                    <div class="row">
        ...
        <div class="screens_area">
            <div class="container">
                <div class="row page_title text-center">
                    ...
                    <h6 class="fuent_new2">Com o mais novo Codec H.265, as imagens ganharam uma considerável melhora em relação com os dispositivos tecnológicos atuais, o Wave HD é impulsado com um exclusivo processador de vídeo extremadamente poderoso, o que lhe permitirá aprimorar de verdade a sua experiência de imagem colorida, além de reduzir drasticamente o consumo da Internet com conteúdos Streaming.
                    </h6>
        ...
        <div class="screens_area">
            <div class="container">
                <div class="row page_title text-center">
                    ...
                    <h6 class="fuent_new3">Conecte-se a uma rede cabeada e comece a desfrutar milhares de horas de surpreendentes conteúdos de TV e Multimídia.</h6>
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3"><img  class="img-responsive" src="{{URL::to('vista/one/conec.jpg')}}" alt=""></div>
                    </div>
                </div>
        ...
        <div class="screens_area">
            <div class="container">
                <div class="row page_title text-center">
                    ...
                    <h6 class="fuent_new2">A Resolução Full HD 1080p oferece uma qualidade impressionante e nitidez melhorada na indústria de vídeos, filmes e todos os tipos de conteúdos digitais. Com ele você terá acesso a todo o conteúdo HD, não só aqueles que vêm através do satélite, mas aqueles que podem ser acessados a partir de outras fontes, como Internet, YouTube e outros dispositivos de armazenamento.</h6>
                    <div class="row">
        ...
        <div class="screens_area">
            <div class="container">
                <div class="row page_title text-center">
                    ...
                    <h6 class="fuent_new2">Muitos aplicativos de Streaming disponíveis, além dos aplicativos da Duosat que você já conhece e as melhores plataformas como YouTube, Dailymotion entre outros.</h6>
                    <div class="row">
                ...
                <div class="row cuadrado">
                    ...
                    <div class="col-md-4 cuad">
                        <div class="">
                            ...
                            <p class="parraf">Sintonizador Duplo. Suporta DVB-S2: 2~45Ms/S, Demodulação: ACM, VCM, QPSK, 8PSK, 16APSK, 32APSK. Conector de Entrada: F-Type, IEC169-24 x 2, Fêmea. Frequência de Entrada 950~2150MHz. LNB e Polarização: Vertical: +13.5V, Horizontal: +18V, Atual: Max 450mA
                            </p>
                    ...
                    <div class="col-md-4 cuad">
                        <div class="">
                            ...
                            <p class="parraf">DDR3 256MB, Memória Flash16MB</p>
                    ...
                    <div class="col-md-4 cuad">
                        <div class="">
                            ...
                            <p class="parraf">Internet (LAN) 1 x RJ45</p>
                    ...
                    <div class="col-md-4 cuad">
                        <div class="">
                            ...
                            <p class="parraf">Tamanho: 170mm x 40mm x 118mm (W x H x D)
                                Peso: Aprox. 0.8 Kg
                    ...
                    <div class="col-md-4 cuad">
                        <div class="">
                            ...
                            <p class="parraf">MPEG/MusiCam Layer I/II/III, AAC, HE-AAC, AC-3, EAC3, OGG, FLAG, APE. Modo: Single Channel, Dual Channel, Joint Stereo, e Estéreo</p>
                    ...
                    <div class="col-md-4 cuad">
                        <div class="">
                            ...
                            <h4 class="fuente_titulo4">Fonte de Alimentação:</h4>
        ...
        <div class="contact_area">
            <div class="container">
                <div class="row page_title text-center">
                    ...
                    <br>
                    <iframe width="700" height="400" src="https://www.youtube.com/embed/nRyqnkvUE0I" frameborder="0" allowfullscreen></iframe>
...
<script src="{{URL::to('vista/wave/js/main.js')}}"></script>
